...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='dfashion',
                             help='coco | kitti | coco_hp | pascal | dfashion')
    ...
    # model
    self.parser.add_argument('--arch', default='mbnv2', 
                             help='model architecture. Currently tested'
                                  'res_18 | res_101 | resdcn_18 | resdcn_101 |'
                                  'dlav0_34 | dla_34 | hourglass | mbnv2')
